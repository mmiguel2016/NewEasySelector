...
public class AICCorrosionDO60 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aiccorrosiondo60);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_aiccorrosiondo60));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AICCorrosionDO60.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.aiccorrosiondo601));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.aiccorrosiondo602));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.aiccorrosiondo603));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(AICCorrosionDO60.this, Selections.class);
        startActivity(intent);
        return true;
    }
}