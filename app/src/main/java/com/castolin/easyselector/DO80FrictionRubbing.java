 ...
 */
public class DO80FrictionRubbing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.do80frictionrubbing);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_do80frictionrubbing));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DO80FrictionRubbing.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.DO80frictionrubbing1));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.DO80frictionrubbing2));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.DO80frictionrubbing3));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(DO80FrictionRubbing.this, Selections.class);
        startActivity(intent);
        return true;
    }
