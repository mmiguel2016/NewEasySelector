 ...
 */
public class EG8336 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eg8336);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_EG8336));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(EG8336.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.EG83361));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.EG83362));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.EG83363));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(EG8336.this, Selections.class);
        startActivity(intent);
        return true;
    }
}
