...
public class AIHImpactAbrasionDO06 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aihimpactabrasiondo06);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_aihimpactabrasiondo06));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AIHImpactAbrasionDO06.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.aihimpactabrasiondo061));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.aihimpactabrasiondo062));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.aihimpactabrasiondo063));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(AIHImpactAbrasionDO06.this, Selections.class);
        startActivity(intent);
        return true;
    }
}