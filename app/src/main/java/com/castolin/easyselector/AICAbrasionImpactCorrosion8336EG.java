...
public class AICAbrasionImpactCorrosion8336EG extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aicabrasionimpactcorrosion8336eg);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_aicabrasionimpactcorrosion8336eg));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AICAbrasionImpactCorrosion8336EG.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.aicabrasionimpactcorrosion8336eg1));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.aicabrasionimpactcorrosion8336eg2));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.aicabrasionimpactcorrosion8336eg3));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(AICAbrasionImpactCorrosion8336EG.this, Selections.class);
        startActivity(intent);
        return true;
    }
}