...
public class AIHAbrasionImpactHeatDO60 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aihabrasionimpactheatdo60);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_aihabrasionimpactheatdo60));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AIHAbrasionImpactHeatDO60.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.aihabrasionimpactheatdo601));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.aihabrasionimpactheatdo602));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.aihabrasionimpactheatdo603));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(AIHAbrasionImpactHeatDO60.this, Selections.class);
        startActivity(intent);
        return true;
    }
}