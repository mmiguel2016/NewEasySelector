...
public class AICImpactCorrosionCAVITEC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aicimpactcorrosioncavitec);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_aicimpactcorrosioncavitec));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AICImpactCorrosionCAVITEC.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.aicimpactcorrosioncavitec1));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.aicimpactcorrosioncavitec2));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.aicimpactcorrosioncavitec3));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(AICImpactCorrosionCAVITEC.this, Selections.class);
        startActivity(intent);
        return true;
    }
}