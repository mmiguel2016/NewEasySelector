 ...
 */
public class DO360X extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.do360x);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_do360x));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DO360X.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.DO360X1));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.DO360X2));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.DO360X3));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(DO360X.this, Selections.class);
        startActivity(intent);
        return true;
    }
