 ...
 */
public class DO60 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.do60);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_do60));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DO60.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.DO601));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.DO602));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.DO603));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(DO60.this, Selections.class);
        startActivity(intent);
        return true;
    }
