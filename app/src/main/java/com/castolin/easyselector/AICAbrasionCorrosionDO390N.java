...
public class AICAbrasionCorrosionDO390N extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aicabrasioncorrosiondo390n);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_aicabrasioncorrosiondo390n));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AICAbrasionCorrosionDO390N.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.aicabrasioncorrosiondo390n1));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.aicabrasioncorrosiondo390n2));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.aicabrasioncorrosiondo390n3));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(AICAbrasionCorrosionDO390N.this, Selections.class);
        startActivity(intent);
        return true;
    }
}