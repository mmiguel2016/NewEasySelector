...
public class AICImpactCorrosionDO05 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aicimpactcorrosiondo05);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_aicimpactcorrosiondo05));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AICImpactCorrosionDO05.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.aicimpactcorrosiondo051));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.aicimpactcorrosiondo052));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.aicimpactcorrosiondo053));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(AICImpactCorrosionDO05.this, Selections.class);
        startActivity(intent);
        return true;
    }
}