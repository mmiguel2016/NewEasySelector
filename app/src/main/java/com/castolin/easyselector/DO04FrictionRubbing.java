 ...
 */
public class DO04FrictionRubbing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.do04frictionrubbing);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_do04frictionrubbing));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DO04FrictionRubbing.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.DO04FrictionRubbing1));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.DO04FrictionRubbing2));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.DO04FrictionRubbing3));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(DO04FrictionRubbing.this, Selections.class);
        startActivity(intent);
        return true;
    }
