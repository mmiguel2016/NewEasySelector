...
public class AIHImpactHeatDO04 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aihimpactheatdo04);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_aihimpactheatdo04));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AIHImpactHeatDO04.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.aihimpactheatdo041));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.aihimpactheatdo042));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.aihimpactheatdo043));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(AIHImpactHeatDO04.this, Selections.class);
        startActivity(intent);
        return true;
    }
}