...
public class AHCAbrasionHeatCorrosionDO70 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ahcabrasionheatcorrosiondo70);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_ahcabrasionheatcorrosiondo70));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AHCAbrasionHeatCorrosionDO70.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.ahcabrasionheatcorrosiondo701));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.ahcabrasionheatcorrosiondo702));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.ahcabrasionheatcorrosiondo703));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(AHCAbrasionHeatCorrosionDO70.this, Selections.class);
        startActivity(intent);
        return true;
    }
}