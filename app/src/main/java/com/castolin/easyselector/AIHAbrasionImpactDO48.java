...
public class AIHAbrasionImpactDO48 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aihabrasionimpactdo48);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_aihabrasionimpactdo48));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AIHAbrasionImpactDO48.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.aihabrasionimpactdo481));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.aihabrasionimpactdo482));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.aihabrasionimpactdo483));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(AIHAbrasionImpactDO48.this, Selections.class);
        startActivity(intent);
        return true;
    }
}