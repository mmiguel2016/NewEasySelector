 ...
 */
public class DO390N extends AppCompatActivity {
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.DO390N1));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.DO390N2));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.DO390N3));
