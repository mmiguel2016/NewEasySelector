...
public class HICHeatImpactCorrosionDO80 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hicheatimpactcorrosiondo80);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_hicheatimpactcorrosiondo80));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HICHeatImpactCorrosionDO80.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.hicheatimpactcorrosiondo801));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.hicheatimpactcorrosiondo802));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.hicheatimpactcorrosiondo803));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(HICHeatImpactCorrosionDO80.this, Selections.class);
        startActivity(intent);
        return true;
    }
}