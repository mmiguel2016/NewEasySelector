...
public class AICAbrasionCorrosionDO11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aicabrasioncorrosiondo11);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_aicabrasioncorrosiondo11));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AICAbrasionCorrosionDO11.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.aicabrasioncorrosiondo111));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.aicabrasioncorrosiondo112));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.aicabrasioncorrosiondo113));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(AICAbrasionCorrosionDO11.this, Selections.class);
        startActivity(intent);
        return true;
    }
}