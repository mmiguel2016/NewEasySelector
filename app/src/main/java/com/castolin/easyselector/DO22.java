 ...
 */
public class DO22 extends AppCompatActivity{
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.DO221));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.DO222));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.DO223));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(DO22.this, Selections.class);
        startActivity(intent);
        return true;
    }
}
