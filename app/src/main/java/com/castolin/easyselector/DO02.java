 ...
 */
public class DO02 extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.do02);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_DO02));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DO02.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.DO021));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.DO022));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.DO023));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(DO02.this, Selections.class);
        startActivity(intent);
        return true;
    }
}
