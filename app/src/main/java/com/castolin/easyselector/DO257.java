 ...
 */
public class DO257 extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.do257);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_DO257));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DO257.this, Feedback.class);
...
// get the listview
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.DO2571));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.DO2572));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.DO2573));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(DO257.this, Selections.class);
        startActivity(intent);
        return true;
    }
}
