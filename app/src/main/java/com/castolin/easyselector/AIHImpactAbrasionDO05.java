...
public class AIHImpactAbrasionDO05 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aihimpactabrasiondo05);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_aihimpactabrasiondo05));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AIHImpactAbrasionDO05.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.aihimpactabrasiondo051));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.aihimpactabrasiondo052));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.aihimpactabrasiondo053));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(AIHImpactAbrasionDO05.this, Selections.class);
        startActivity(intent);
        return true;
    }
}