 ...
 */
public class DO02Cavitation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.do02cavitation);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_DO02cavitation));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DO02Cavitation.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.DO02cavitation1));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.DO02cavitation2));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.DO02cavitation3));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(DO02Cavitation.this, Selections.class);
        startActivity(intent);
        return true;
    }
}
