...
public class AHCCorrosionHeatDO84 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ahccorrosionheatdo84);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_ahccorrosionheatdo84));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AHCCorrosionHeatDO84.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.ahccorrosionheatdo841));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.ahccorrosionheatdo842));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.ahccorrosionheatdo843));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(AHCCorrosionHeatDO84.this, Selections.class);
        startActivity(intent);
        return true;
    }
}