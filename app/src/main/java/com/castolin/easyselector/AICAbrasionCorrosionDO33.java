...
public class AICAbrasionCorrosionDO33 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aicabrasioncorrosiondo33);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_aicabrasioncorrosiondo33));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AICAbrasionCorrosionDO33.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.aicabrasioncorrosiondo331));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.aicabrasioncorrosiondo332));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.aicabrasioncorrosiondo333));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(AICAbrasionCorrosionDO33.this, Selections.class);
        startActivity(intent);
        return true;
    }
}