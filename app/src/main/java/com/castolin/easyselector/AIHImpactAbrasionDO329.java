...
public class AIHImpactAbrasionDO329 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aihimpactabrasiondo329);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_aihimpactabrasiondo329));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AIHImpactAbrasionDO329.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.aihimpactabrasiondo3291));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.aihimpactabrasiondo3292));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.aihimpactabrasiondo3293));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(AIHImpactAbrasionDO329.this, Selections.class);
        startActivity(intent);
        return true;
    }
}