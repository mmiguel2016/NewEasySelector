 ...
 */
public class DO322 extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.do322);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_DO322));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DO322.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.DO3221));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.DO3222));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.DO3223));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(DO322.this, Selections.class);
        startActivity(intent);
        return true;
    }
}