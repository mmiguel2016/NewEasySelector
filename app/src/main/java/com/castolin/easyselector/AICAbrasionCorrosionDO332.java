...
public class AICAbrasionCorrosionDO332 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aicabrasioncorrosiondo332);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_aicabrasioncorrosiondo332));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AICAbrasionCorrosionDO332.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.aicabrasioncorrosiondo3321));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.aicabrasioncorrosiondo3322));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.aicabrasioncorrosiondo3323));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(AICAbrasionCorrosionDO332.this, Selections.class);
        startActivity(intent);
        return true;
    }
}