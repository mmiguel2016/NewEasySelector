...
public class AHCAbrasionHeatCorrosionDO04 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ahcabrasionheatcorrosiondo04);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_ahcabrasionheatcorrosiondo04));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AHCAbrasionHeatCorrosionDO04.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.ahcabrasionheatcorrosiondo041));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.ahcabrasionheatcorrosiondo042));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.ahcabrasionheatcorrosiondo043));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(AHCAbrasionHeatCorrosionDO04.this, Selections.class);
        startActivity(intent);
        return true;
    }
}