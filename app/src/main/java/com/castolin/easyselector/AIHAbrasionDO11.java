...
public class AIHAbrasionDO11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aihabrasiondo11);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_aihabrasiondo11));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AIHAbrasionDO11.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.aihabrasiondo111));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.aihabrasiondo112));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.aihabrasiondo113));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(AIHAbrasionDO11.this, Selections.class);
        startActivity(intent);
        return true;
    }
}