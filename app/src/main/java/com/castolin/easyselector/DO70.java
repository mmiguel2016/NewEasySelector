 ...
 */
public class DO70 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.do70);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_do70));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DO70.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.DO701));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.DO702));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.DO703));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(DO70.this, Selections.class);
        startActivity(intent);
        return true;
    }
