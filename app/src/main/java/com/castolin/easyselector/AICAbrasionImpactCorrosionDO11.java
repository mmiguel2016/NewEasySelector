...
public class AICAbrasionImpactCorrosionDO11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aicabrasionimpactcorrosiondo11);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        Toolbar toolbarHeader = (Toolbar) findViewById(R.id.toolbar_2nd);
        toolbarHeader.setTitle(getString(R.string.title_activity_aicabrasionimpactcorrosiondo11));
        ...
        toolbarBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AICAbrasionImpactCorrosionDO11.this, Feedback.class);
    ...
    private void prepareListData() {
        ...
        part.add(getString(R.string.aicabrasionimpactcorrosiondo111));


        List<String> wear = new ArrayList<String>();
        wear.add(getString(R.string.aicabrasionimpactcorrosiondo112));

        List<String> advantages = new ArrayList<String>();
        advantages.add(getString(R.string.aicabrasionimpactcorrosiondo113));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent intent = new Intent(AICAbrasionImpactCorrosionDO11.this, Selections.class);
        startActivity(intent);
        return true;
    }
}